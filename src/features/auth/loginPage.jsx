    ...
    return (
        <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full bg-white shadow-sm border border-gray-200 rounded-xl p-8">
                ...
                <p className="text-sm text-gray-500 text-center mb-6">Sign in to your ClassMatch account</p>
                ...
                <form className="space-y-4" onSubmit={handleLogin}>
                    ...
                    <div>
                        ...
                        <div className="mt-2 text-right">
                            <Link to="/reset-password" className="text-xs font-medium text-blue-600 hover:text-blue-500">
                                Forgot password?
                            </Link>
                        </div>
                    </div>
                    ...
                    <button
                        type="submit"
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 rounded-lg shadow-sm transition text-sm"
                    >
                        Sign In
                    </button>
                </form>
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg py-2.5 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50 transition shadow-sm"
                >
